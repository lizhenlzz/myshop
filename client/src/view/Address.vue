      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressList" :key="index" :class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddrId">
                  <dl>
                    <dt>{{item.userName}}</dt>
          ...
          <div class="lemall-msg-info hidden">
            <span>您选择的区域不在我们的交货区域内。 请在我们的交货区域内选择另一个送货地址。</span>
          </div>
            ...
            <div class="shipping-method">
              <ul>
                <li class="check">
                  ...
                  <div class="price">lzlzlz</div>
                  <div class="shipping-tips">
                    <p>发货之后，订单将在1-7个工作日内到达目的地</p>
                  </div>
                </li>
              </ul>
            </div>
